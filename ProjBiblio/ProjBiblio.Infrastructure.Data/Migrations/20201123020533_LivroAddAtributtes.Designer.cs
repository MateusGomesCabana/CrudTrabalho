...
namespace ProjBiblio.Infrastructure.Data.Migrations
{
    ...
    [Migration("20201123020533_LivroAddAtributtes")]
    partial class LivroAddAtributtes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjBiblio.Domain.Entities.CampanhaMarketing", b =>
                {
                    b.Property<int>("CampanhaMarketingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("CampanhaMarketingID");

                    b.ToTable("CampanhaMarketing");
                });

            modelBuilder.Entity("ProjBiblio.Domain.Entities.CampanhaMarketingLivro", b =>
                {
                    b.Property<int>("CampanhaMarketingID")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("CampanhaMarketingID", "LivroID");
            ...
            modelBuilder.Entity("ProjBiblio.Domain.Entities.CampanhaMarketingLivro", b =>
                {
                    b.HasOne("ProjBiblio.Domain.Entities.CampanhaMarketing", "CampanhaMarketing")
                        .WithMany("CampanhaMarketingLivro")
                        .HasForeignKey("CampanhaMarketingID")
